package com.example.basicscalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button0,button1,button2,button3,button4,button5,button6,button7,button8,button9,buttonAddition,
                   buttonSubs,buttonMultiply,buttonDivision,buttonPower,buttonPoint,buttonPercent,buttonEqual,
                   buttonClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddition =findViewById(R.id.Addition_btn);
        buttonSubs =findViewById(R.id.Subs_btn);
        buttonMultiply =findViewById(R.id.multipy_btn);
